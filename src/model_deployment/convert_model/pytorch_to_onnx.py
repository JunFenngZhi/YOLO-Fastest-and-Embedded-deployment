...
net_param = torch.load("E:\Graduate_Design\YOLO-Fastest\models\pytorch\\256x320\YOLO-Fastest_epoch_28.pth", map_location="cpu")
...
# Export the model
torch_out = torch.onnx._export(net, x, "YOLO-Fastest_epoch_28.onnx", export_params=True)
