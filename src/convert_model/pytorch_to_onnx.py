...
net_param = torch.load("E:\Graduate_Design\YOLO-Fastest\models\model_v3\YOLO-Fastest_epoch_29.pth", map_location="cpu")
...
# Export the model
torch_out = torch.onnx._export(net, x, "YOLO-Fastest_epoch_29.onnx", export_params=True)
